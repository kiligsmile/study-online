...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/study-online-generator/src/main/java");
		gc.setAuthor("kiligsmile");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://10.211.55.4:3306/studyonline_" + SERVICE_NAME
